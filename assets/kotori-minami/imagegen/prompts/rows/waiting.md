Create one horizontal animation strip for Codex pet `kotori-minami`, state `waiting`.
...
State action: Waiting loop: both hands holding cheeks, looking toward the screen with warm expectant eyes.
