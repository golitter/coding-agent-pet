Create one horizontal animation strip for Codex pet `kotori-minami`, state `jumping`.
...
Identity: same pet in every frame: Pixel-art chibi desktop pet inspired by Kotori Minami: flaxen hair, amber eyes, iconic side half-up hairstyle with a green ribbon bow, Otonokizaka-style school idol uniform palette with a green neck bow, gentle healing personality with a slightly airheaded charm, compact full-body silhouette, optional tiny attached (bird-like) companion motif or alpaca plush, no text, no logos, no scenery.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
...
State action: Done loop: happy little turn-in-place jump, anticipation, lift, cheerful peak, descent, and settle through body height.

State requirements:
- Show the happy jump through pose and vertical body position only: anticipation, lift, cheerful peak, descent, settle.
