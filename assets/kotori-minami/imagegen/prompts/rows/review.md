Create one horizontal animation strip for Codex pet `kotori-minami`, state `review`.
...
State action: Thinking loop: gentle head tilt, finger near mouth, thoughtful blink, and slightly curious expression.

State requirements:
- Show thinking through head tilt, blink, finger-near-mouth pose, and subtle curious posture.
