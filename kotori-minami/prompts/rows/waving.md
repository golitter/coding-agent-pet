Create one horizontal animation strip for Codex pet `kotori-minami`, state `waving`.
...
State action: Done loop: happy greeting and tiny hand-heart gesture, hand down, raised, heart pose, and returning.
